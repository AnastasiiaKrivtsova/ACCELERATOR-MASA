...
var mainNav = document.querySelector('.header-nav__menu-wrapper');
var listItems = document.querySelectorAll('.header-nav__menu-item');
...
var setProgramsSwiper = function setProgramsSwiper() {
  if (document.body.contains(document.querySelector('.programms__swiper-wrapper'))) {
    new _swiper.default('.programms__swiper-wrapper', {
      loop: false,
      breakpoints: {
        320: {
          allowTouchMove: true,
...
},{"./blocks/init-accordion":2,"./blocks/menu":3,"./blocks/news-sorter":4,"./blocks/page-swiper":5,"./modules/form-validate/custom-select":9,"./modules/form-validate/form":10,"./modules/modals/init-modals":17,"./utils/ios-vh-fix":21}],7:[function(require,module,exports){
"use strict";
